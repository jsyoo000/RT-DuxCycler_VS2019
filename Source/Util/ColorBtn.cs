...
namespace Duxcycler
{
    public class ColorBtn : System.Windows.Forms.Button
    {
        ...
        protected class ColorPanel : System.Windows.Forms.Form
        {
            ...
            public ColorPanel( Point pt, ColorBtn button )
            {
                colorButton = button ;
            ...
            protected override void OnClick( EventArgs e )
            {
                ...
                //if ( colorIndex < 40 )
                //    colorButton.ColorVaule = colorList[colorIndex] ;
