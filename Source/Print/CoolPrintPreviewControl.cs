...
namespace CoolPrintPreview
{
    ...
    internal class CoolPrintPreviewControl : UserControl
    {
        ...
        List<Image> _img = new List<Image>();
        ...
        public void RefreshPreview()
        {
            ...
            if (_doc != null)
            {
                _doc.DefaultPageSettings.Margins.Left   = Convert.ToInt32((Global.MarginsLeft) * 10 );
                _doc.DefaultPageSettings.Margins.Right  = Convert.ToInt32((Global.MarginsRight) * 10 );
                _doc.DefaultPageSettings.Margins.Top    = Convert.ToInt32((Global.MarginsTop) * 10);
                _doc.DefaultPageSettings.Margins.Bottom = Convert.ToInt32((Global.MarginsBottom) * 10);
        ...
        internal class DocumentPrinter : PrintDocument
        {
            ...
            public List<Image> ImgList { get { return _imgList; } set { _imgList = value; } }
            ...
            protected override void OnPrintPage(PrintPageEventArgs e)
            {
                ...
                e.Graphics.DrawImage(ImgList[_index++], e.PageBounds);

                // stop when we reach the last page in the range
                e.HasMorePages = _index <= Last;
            }
        }
